...
void SocketManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SocketManager::*)(const QString & )>(_a, &SocketManager::messageReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketManager::*)()>(_a, &SocketManager::connected, 1))
            return;
    }
}
...
// SIGNAL 0
void SocketManager::messageReceived(const QString & _t1)
{
