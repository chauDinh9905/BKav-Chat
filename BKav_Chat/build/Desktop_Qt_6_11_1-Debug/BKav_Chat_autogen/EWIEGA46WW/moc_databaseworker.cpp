...
void DatabaseWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DatabaseWorker::*)(quint64 , QVector<QVariantMap> )>(_a, &DatabaseWorker::messagesReady, 0))
            return;
    }
}
...
// SIGNAL 0
void DatabaseWorker::messagesReady(quint64 _t1, QVector<QVariantMap> _t2)
{
